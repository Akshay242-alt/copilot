...
Coding standards, including the comment philosophy, exported data-layer API documentation, Astro component contracts, and TypeScript formatting conventions, are maintained in the [Copilot instructions](./.github/copilot-instructions.md) and the focused [instruction files](./.github/instructions/).
