...
- Comment only the reason for non-obvious fixtures or assertions; do not comment code that is self-explanatory, and keep comments synchronized with the test.
